...
select instr(first_name ,"b") from worker where worker_id = 4;
...
--  group by ke saath having lagta hai
select * from title;
select * from worker;
...
insert into worker_clone select * from worker; # To insert data in it
